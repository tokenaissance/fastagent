...
// when available, falls back to the FastAgent logo for the platform header
...
//   activeAgentId unset   → show "FastAgent" (platform brand). The dropdown
...
export function AgentSwitcher({
  ...
  const headerLabel = active ? active.name || active.id : "FastAgent";
