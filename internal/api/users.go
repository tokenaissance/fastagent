...
//
// Authenticated by api_key only. Mints (or returns) the fastagent user
...
// fastagent user_id, regardless of whether the row already existed.
//
...
// /v1/chat/completions body (or the X-Fastagent-End-User header) on
